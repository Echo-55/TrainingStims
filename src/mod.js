...
class TrainingStims {
    ...
    postDBLoad(container) {
        ...
        if (config.enable_all === true) {
            ...
            Logger.logWithColor(`${this.modName} - Loaded successfully`, LogTextColor_1.LogTextColor.CYAN);
        }
    }
    addToLocale(locales, id, name, shortname, description) {
